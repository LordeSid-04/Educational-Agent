...
```bash
npx componentry@latest add github-calendar
```
...
|------|------|---------|-------------|
| `username` | `string` | - | The GitHub username to fetch contributions for. (Required) |
| `variant` | `"default" | "city-lights" | "minimal"` | `"default"` | The visual style variant of the calendar. |
| `colorSchema` | `"green" | "blue" | "purple" | "orange" | "gray"` | `"green"` | The color scheme for the contribution cells. |
| `showTotal` | `boolean` | `true` | Whether to show the total contributions count header. |
...
_Component from [Componentry](https://componentry.fun/docs/components/github-calendar)_